...
public class StudentData {
    ...
    public static List<Student> getStudents() {
        ...
        return Arrays.asList(
                new Student(111, "Liva Brein", 17, "Female", "Computer Science", 2018, 70.8),
                new Student(122, "Paul Niskiui", 18, "Male", "Mechanical", 2016, 50.2),
                ...
                new Student(200, "Jaden Dong", 18, "Male", "Security", 2015, 82),
                ...
                new Student(266, "Sani Pandey", 17, "Female", "Electronic", 2019, 72.4),
